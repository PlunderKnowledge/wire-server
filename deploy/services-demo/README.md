...
This document assumes that you have already compiled all services (i.e., you read all of the `README.md` from the top level folder and ran `make services-local` there) and now you want to see how it all fits together.
